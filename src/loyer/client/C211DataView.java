...
public class C211DataView extends LoyerFrame {
  ...
  private void initialize() {
    ...
    table = DataTools.completedTable(DataTools.getTestTable("c211"));
  ...
  @Override
  public void close() {
    RecordTools.outExcl("c211_recordtd");
    TestDataTools.outExcl("c211_testdata");
    System.exit(0);
  }
  /**
  ...
  public void record(int row, String remark) {
    ...
    datas[10] = remark;
    TestDataTools.insert("c211_testdata", datas);
  }
  /**
   * 插入空行
   */
  ...
  public void initCountAndPieChart() {
    RecordData rd = RecordTools.getByDate("c211_recordtd", LocalDate.now().toString());
    if(rd != null) {
